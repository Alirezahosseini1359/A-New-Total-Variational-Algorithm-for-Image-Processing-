%In this code, denoising test image Lena is solved
%with 8 different variational methods:
%1- TC 2-proposed 3-TGV 4-TL 5-Condat  6-Isotropic TV 7-Upwind 8-Infcon
%================================================================================
close all; clc 
ref=double(imread('goldhill.png'))/255;% original image 
ref=ref(300:450,300:500);% a part of image is used in comparison
...
sUpwind=0.17; %regularization parameter for Upwind TV
...
ff=f*255; 
Nbiter=30;%number of iterations
...
xx=1:Nbiter;
figure
plot(xx,vala1, xx,vala2, xx,vala3, xx,vala4, xx,vala5, xx,vala6, xx,vala7,xx,vala8,'LineWidth', 2)
legend('TC', 'Proposed', 'TGV', 'TL', 'Condat TV', 'Isotropic', 'Upwind', 'INFCON','Location', 'SouthEast')
title('Comparison of PSNR')

figure

plot(xx,valb1, xx,valb2, xx,valb3, xx,valb4, xx,valb5,xx,valb6,xx,valb7, xx,valb8,'LineWidth', 2)
