...
%================================================================================
close all; clc 
ref=double(imread('lena_gray_512.png'))/255;% original image 
 ref=ref(200:300,200:400);% a part of image is used in comparison
sTC=10;%regularization parameter for TC
sNew=0.08;%regularization parameter for proposed model
sTGV=0.15; %regularization parameter for TGV
